...
const Article = styled('article', {
  ...
  '--tw-prose-links': slate[900],
  '--tw-prose-bold': slate[900],
  '--tw-prose-counters': slate[500],
  '--tw-prose-bullets': slate[300],
  '--tw-prose-hr': slate[200],
  '--tw-prose-quotes': slate[900],
  '--tw-prose-quote-borders': slate[200],
  '--tw-prose-captions': slate[500],
  '--tw-prose-code': slate[900],
  '--tw-prose-pre-code': slate[200],
  '--tw-prose-pre-bg': slate[800],
  '--tw-prose-th-borders': slate[300],
  '--tw-prose-td-borders': slate[200],
  '--tw-prose-invert-body': slate[300],
  '--tw-prose-invert-headings': '#fff',
  '--tw-prose-invert-lead': slate[400],
  '--tw-prose-invert-links': '#fff',
  '--tw-prose-invert-bold': '#fff',
  '--tw-prose-invert-counters': slate[400],
  '--tw-prose-invert-bullets': slate[600],
  '--tw-prose-invert-hr': slate[700],
  '--tw-prose-invert-quotes': slate[100],
  '--tw-prose-invert-quote-borders': slate[700],
